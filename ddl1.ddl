...
CREATE TABLE Person
  (
    ...
    Departments_dept_id INTEGER ,
    employee_pno        INTEGER
  ) ;
...
ALTER TABLE Person ADD CONSTRAINT Person_Departments_FK FOREIGN KEY ( Departments_dept_id ) REFERENCES Departments ( dept_id ) ;
...
ALTER TABLE Project ADD CONSTRAINT Project_Departments_FK FOREIGN KEY ( Departments_dept_id ) REFERENCES Departments ( dept_id ) ;
...
ALTER TABLE current_projects ADD CONSTRAINT current_projects_Project_FK FOREIGN KEY ( Project_project_id ) REFERENCES Project ( project_id ) ;
